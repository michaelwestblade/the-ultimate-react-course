...
function App() {
  ...
  const archiveOptions = useMemo(
    () => ({
      show: true,
      title: `Post Archive in addition to the search results (${searchedPosts.length})`,
    }),
    [searchedPosts]
  );
...
function Results({ posts }: { posts: PostInterface[] }) {
...
function FormAddPost({ onAddPost }: { onAddPost: any }) {
